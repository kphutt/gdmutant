...
This is the end-to-end sanity check that closes the "never run against real Godot" gate (LOD-73):
...
def test_gdunit4_against_real_godot(tmp_path: Path) -> None:
    """The GdUnit4 path — the LOD-73 close: exercises the real ``-s GdUnitCmdTool.gd -a res://test
